...
bool StateParser::parseState(const char *stateFile, string stateID, vector<GameObject *> *pObjects, vector<string> *pTextureIDs)
{
	...
	for(TiXmlElement* e = pRoot-> FirstChilsdElement(); e != NULL; e = e->NextSiblingElement())
	{
	...
	for(TiXmlElement* e = pStateRoot->FirstChilsdElement(); e != NULL; e = e->NextSiblingElement())
	{
